...
3. **Spawn a `notion-executor` subagent** via the Agent tool. The executor will move the task to `In Progress` itself upon picking it up. Pass the full task context in the prompt, including:
