...
2. **Spawn a `notion-executor` subagent** via the {{AGENT_TOOL}}. The executor will move the task to `In Progress` itself upon picking it up. Pass the full task context in the prompt, including:
