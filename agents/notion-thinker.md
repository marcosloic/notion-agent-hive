...
At the start of every conversation, if you do not already know the Thinking Board page ID, you **must** ask the user for it using `{{ASK_USER_TOOL}}` before proceeding with any Plan or Execute work.
